...
(por exemplo, \textit{crosstalk}) não são incorporadas~\cite{Meesters2004}. Até agora, poucos métodos objetivos de avaliação 
...
A tecnologia 2D atualmente existente mede a qualidade objetiva de cores individuais e as sequências de mapa de profundidade não representam a 
...
as limitações de PSNR também foram analisadas para vídeos 2D.
...
jogos, as imagens 3D e vídeos precisam ser processadas, transmitidas e distribuídas para vários usuários. 
Portanto, é importante definir procedimentos subjetivos e objetivos para avaliar a qualidade do processamento de vídeos estéreos. 
...
sequências de vídeo codificados de maneira diferente, com taxas de perda de pacotes que variam de 0\% a 20\%. 
...
Foi mostrado que com o aumento da profundidade se obtém um maior sentido de presença, desde que a profundidade é percebida 
...
%Stereo oferece precisão e confiabilidade em testes de estereoscopia. Padrões de pontos aleatórios requer que o indivíduo binocular extraia 
...
%distorções na visão estereoscópica. Essas distorções desencadeiam mudanças na profundidade percebida. 
...
%adequado para avaliar a contribuição do mapa de profundidade das \textbf{pistas} binocular (estereoscopia, por 
